...
const PROFILE_LIST = [
  ...
  },
  {
    ...
    name: 'Segurança',
    icon:
      <IconIonicons name="shield-checkmark-outline" size={28} color="#8C6FF7" />,
  },
  {
    id: 4,
    name: 'Ajuda',
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: '#ffffff'}}>
      <ScrollView
        ...
        contentContainerStyle={{
          paddingBottom: getNormalizedVerticalSizeWithPlatformOffset(150),
        }}>
        <Box marginHorizontal="m">
          ...
          <Box alignSelf="center" mt="l" alignItems="center">
            ...
            />
            <Text mt="sm" fontSize={16} fontWeight="700" color="black400">
              Thiago Lourenço
            </Text>
            <Text fontSize={14} fontWeight="600" color="black400">
          ...
          <TouchableOpacity onPress={handleIsPremium} activeOpacity={1}>
            <Box
              ...
              <Box flexDirection="row" alignItems="center">
                ...
                <Text color="white" fontWeight="bold" marginLeft="sm">
                  Faça o upgrade do plano
                </Text>
              </Box>
              <Text color="white" fontWeight="400" marginTop="sm">
                Desbloqueie as melhores funcionalidade do seu Aplicativo
              </Text>
            </Box>
          </TouchableOpacity>
          ...
          <Box mt="ml">
            {PROFILE_LIST.map((item, index) => (
              <TouchableOpacity
                activeOpacity={0.8}
                onPress={() =>
                  item.name === 'Sair' ? handleIsOpenBottomSheetLogout() : {}
                }
                style={{
                  flexDirection: 'row',
                  alignItems: 'center',
      ...
      {isLogout && (
        <BottomSheet
          ...
          onClose={handleClose}
          height={240}
          children={<Logout onClose={handleClose}/>}
